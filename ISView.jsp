...
<header class="clearfix">
  ...
  <section role="banner">
   ...
   <li class='active has-sub'><a href='PMView.jsp'><span>6.1.1</span></a>
      
	 <ul>
         <li class='has-sub'><a href='PMView.jsp'><span>nGeniousONE Builds</span></a>
...
/*var mydata = [{
	...
	try
	{
		...
		{
			ISBuildNoList.add(myResultSet.getString(1));
			PMBuildNoList.add(myResultSet.getString(2));
...
<%for(int j=0;j<PMBuildNoList.size();j++)
	{ 
	  ...
	  out.println("{ISBuild:\""+ISBuildNoList.get(j).toString()+"\",nGeniusONEBuild:\""+PMBuildNoList.get(j).toString()+"\",OSType:\""+SetupTypeList.get(j).toString()+"\",PassCount:\""+PassCountList.get(j).toString()+"\",FailCount:\""+FailCountList.get(j).toString()+"\",DiffCount:\""+DiffCountList.get(j).toString()+"\",ToolsDetails:\""+ISBuildNoList.get(j).toString()+"\"},");}%>

];
$("#grid").jqGrid({
	caption: "InfiniStream Build Wise Automation Execution Summary 6.1.1",
    data: mydata,
    datatype: "local",
	height:900,
	autowidth:true,
    ...
    sortname: 'ISBuild',
    sortorder: 'desc',
    colNames: ["IS Build", "nGeniusONEBuild","Setup Type","Pass Testcases","Fail Testcases","Details"],
    colModel: [
	{
        name: 'ISBuild',
        index: 'ISBuild',
...
function returnHyperLink(cellValue, options, rowdata, action) 
		...
		return "<a href=getISBuildExecutionList.jsp?ISBuildNo="+ cellValue +"&setupType="+rowdata['OSType']+">"+"<Font size=\"2px\" style='color:#0080FF;' target='_blank'>Launch Details</a></font>";
		} 
...
<footer role="contentinfo">
      <p>
        ...
        <a href="index.jsp">HOME</a> |  <a href="automationsuites.html">AUTOMATION SUITES</a> |  <a href="automationsuites.jsp">DOWNLOAD</a> | <a href="contact.html">CONTACT US</a>
      </p>
  </footer>
</head>
</body>
