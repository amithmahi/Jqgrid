...
<header class="clearfix">
  ...
  <li class='active has-sub'><a href='#'><span>Patch</span></a>
      <ul>
          <li class='has-sub'><a href='PMView_5.5.3.jsp'><span>5.5.2 builds</span></a>
...
-->
   ...
   <section role="banner">
       ...
       <article role="main" class="clearfix">
           <div class="post">
             <h3>Infinistream ASI Automation Suite.</h3>
			 <h3>Detailed Execution Status.</h3>
			 <p><strong>View Infinistream ASI Automation Suite Build Wise Status.</strong></p>
...
/*var mydata = [{
	...
	try
	{
		...
		String myQuery = "SELECT PMBuild,ISBuild,TestCasePassed,TestCaseFailed,TestCaseDiff,ReportLocation,overallresult FROM AutomationExecutionDetails WHERE product = 'ASI' and productversion = '6.0' Order by ISBUILD Desc";
...
$("#grid").jqGrid({
	caption: "ASI Automation Results - 6.0",
    data: mydata,
    datatype: "local",
	height:232,
	autowidth:true,
...
function returnHyperLink(cellValue, options, rowdata, action) 
		{     
		return "<u><font size=\"2px\"><a href='./ASIReports/ASIReport_"+cellValue+".html"+"' style='color:#0080FF;' target='_blank'>Launch Report</a></font></u>";
		}   
...
var highchartsOptions = Highcharts.setOptions(Highcharts.theme);
        ...
        $('#canvas1').highcharts({
            ...
            title: {
                text: 'ASI Automation Results - 6.0',
				align: 'left'
            },
			credits: {
            enabled: false
...
<footer role="contentinfo">
      <p>
        ...
        <a href="index.jsp">HOME</a> | <a href="dashboard.html">DASHBOARD</a> | <a href="automationsuites.html">AUTOMATION SUITES</a> |  <a href="automationsuites.jsp">DOWNLOAD</a> | <a href="contact.hmtl">CONTACT US</a>
      </p>
  </footer>
